...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        final isLoading = productsController.isLoading && productsController.popularProducts.isEmpty;
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      title: Column(
        ...
        children: const [
          Text('Hello Alex,', style: TextStyle(fontSize: 16, color: AppColors.textSecondary)),
          SizedBox(height: 4),
          Text('Good Morning!'),
        ],
      ),
