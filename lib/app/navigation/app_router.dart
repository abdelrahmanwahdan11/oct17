...
class AppRouter {
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      case 'onboarding':
        return _buildDefaultRoute(const OnboardingScreen(), settings);
      case 'auth.login':
        return _buildDefaultRoute(const LoginScreen(), settings);
      case 'auth.register':
        return _buildDefaultRoute(const RegisterScreen(), settings);
      case 'home':
